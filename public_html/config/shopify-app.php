...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Diamond Customizer'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', 'b8202235ace813f3fa2d48c473538cea'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', 'f11bb04cd6ddfaa60532e0f1a29a5e86'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,write_script_tags,read_customers,write_customers,read_metaobjects,read_orders,write_orders'),
    ...
    */
    ...
    'webhooks' => [
            ...
            //     'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://app.billigjewelers.com/webhook/app-uninstalled')
            // ],
            [
                'topic' => env('SHOPIFY_WEBHOOK_1_TOPIC', 'orders/create'),
                'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://app.billigjewelers.com/webhook/orders-create')
            ],
       		[
                'topic' => env('SHOPIFY_WEBHOOK_2_TOPIC', 'order_transactions/create'),
                'address' => env('SHOPIFY_WEBHOOK_2_ADDRESS', 'https://app.billigjewelers.com/webhook/order-transactions-create')
            ],
    ],
